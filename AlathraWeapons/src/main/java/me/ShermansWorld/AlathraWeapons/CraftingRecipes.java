...
public class CraftingRecipes implements Listener {
  public void katanaRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "1");
  ...
  public void ironSpearRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "4");
  ...
  public void ironFlangedMaceRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "6");
  ...
  public void ironNaginataRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "5");
  ...
  public void ironPikeRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "3");
  ...
  public void ironDaggerRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "7");
  ...
  public void ironMorningStarRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "8");
  ...
  public void ironZweihanderRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "9");
  ...
  public void ironWarHammerRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "10");
  ...
  public void ironShortswordRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "11");
  ...
  public void ironQuarterStaffRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "2");
  ...
  public void ironHatchetRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "12");
  ...
  public void ironBattleaxeRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "13");
  ...
  public void ironCombatAxeRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "14");
  ...
  public void ironHalberdRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "15");
  ...
  public void legendaryKatanaRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "16");
  ...
  public void netheriteSpearRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "17");
  ...
  public void netheriteFlangedMaceRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "18");
  ...
  public void netheriteNaginataRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "19");
  ...
  public void netheritePikeRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "20");
  ...
  public void netheriteDaggerRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "21");
  ...
  public void netheriteMorningStarRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "22");
  ...
  public void netheriteZweihanderRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "23");
  ...
  public void netheriteWarHammerRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "24");
  ...
  public void netheriteShortswordRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "25");
  ...
  public void netheriteQuarterStaffRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "26");
  ...
  public void netheriteHatchetRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "27");
  ...
  public void netheriteBattleaxeRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "28");
  ...
  public void netheriteCombatAxeRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "29");
  ...
  public void netheriteHalberdRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "30");
  ...
  public void ironKunaiRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "31");
  ...
  public void netheriteKunaiRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "32");
  ...
  public void ironSabreRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "33");
  ...
  public void netheriteSabreRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "34");
  ...
  public void ironTwinBladeRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "35");
  ...
  public void netheriteTwinBladeRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "36");
  ...
  public void ironBattleHoeRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "37");
  ...
  public void netheriteBattleHoeRecipe() {
    ...
    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "38");
  ...
  public void obsidianObliteratorRecipe() {
	    ...
	    NamespacedKey key = new NamespacedKey((Plugin)Main.getInstance(), String.valueOf(Main.getInstance().getDescription().getName()) + "39");
