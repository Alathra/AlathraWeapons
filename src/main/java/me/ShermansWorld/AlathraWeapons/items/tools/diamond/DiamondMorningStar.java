...
public class DiamondMorningStar implements CustomItem {
    @Override
    public void register() throws InvalidMaterialException {
        ...
        final CustomWeapon diamondItem = new CustomWeapon("Diamond Morning Star", "Diamond Morning Star", 531, WeaponMaterial.DIAMOND, WeaponType.AXE);
