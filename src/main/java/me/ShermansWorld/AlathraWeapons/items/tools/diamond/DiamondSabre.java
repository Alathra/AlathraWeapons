...
public class DiamondSabre implements CustomItem {
    @Override
    public void register() throws InvalidMaterialException {
        ...
        final CustomWeapon diamondItem = new CustomWeapon("Diamond Sabre", "Diamond Sabre", 339, WeaponMaterial.DIAMOND, WeaponType.SWORD);
