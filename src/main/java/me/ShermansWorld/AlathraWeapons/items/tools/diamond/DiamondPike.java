...
public class DiamondPike implements CustomItem {
    @Override
    public void register() throws InvalidMaterialException {
        ...
        final CustomWeapon diamondItem = new CustomWeapon("Diamond Pike", "Diamond Pike", 333, WeaponMaterial.DIAMOND, WeaponType.SWORD);
