...
public class DiamondKunai implements CustomItem {
    @Override
    public void register() throws InvalidMaterialException {
        ...
        final CustomWeapon diamondItem = new CustomWeapon("Diamond Kunai", "Diamond Kunai", 338, WeaponMaterial.DIAMOND, WeaponType.SWORD);
