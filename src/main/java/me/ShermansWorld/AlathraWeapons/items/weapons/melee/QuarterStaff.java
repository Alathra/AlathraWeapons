...
public class QuarterStaff implements CustomItemGroup {
    ...
    public void register() throws InvalidMaterialException {
        ...
        new RecipeFactory("26", netheriteItem.getItemStack(), RecipeShape.SHAPED)
            .shape("  @", " % ", "@  ")
        ...
        new RecipeFactory("111", goldItem.getItemStack(), RecipeShape.SHAPED)
            .shape("  @", " % ", "@  ")
            .setIngredient('@', Material.GOLD_INGOT)
            .setIngredient('%', Material.STICK)
            .build();

        new RecipeFactory("2", ironItem.getItemStack(), RecipeShape.SHAPED)
            .shape("  @", " % ", "@  ")
