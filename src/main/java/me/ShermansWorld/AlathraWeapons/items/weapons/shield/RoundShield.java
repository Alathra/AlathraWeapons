...
public class RoundShield implements CustomItemGroup {
    @Override
    public void register() throws InvalidMaterialException {
        final CustomItem shieldItem = new CustomItem("Round Shield", "Round Shield", 401, WeaponMaterial.IGNORED, WeaponType.SHIELD);
