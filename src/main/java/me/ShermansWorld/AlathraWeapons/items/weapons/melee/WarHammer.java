...
public class WarHammer implements CustomItemGroup {
    ...
    public void register() throws InvalidMaterialException {
        ...
        new RecipeFactory("24", netheriteItem.getItemStack(), RecipeShape.SHAPED)
            .shape(" @ ", " %@", "%  ")
        ...
        new RecipeFactory("127", goldItem.getItemStack(), RecipeShape.SHAPED)
            .shape(" @ ", " %@", "%  ")
            .setIngredient('@', Material.GOLD_INGOT)
            .setIngredient('%', Material.STICK)
            .build();

        new RecipeFactory("10", ironItem.getItemStack(), RecipeShape.SHAPED)
            .shape(" @ ", " %@", "%  ")
