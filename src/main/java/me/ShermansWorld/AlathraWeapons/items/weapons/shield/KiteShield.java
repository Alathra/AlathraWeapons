...
public class KiteShield implements CustomItemGroup {
    @Override
    public void register() throws InvalidMaterialException {
        final CustomItem shieldItem = new CustomItem("Kite Shield", "Kite Shield", 402, WeaponMaterial.IGNORED, WeaponType.SHIELD);
